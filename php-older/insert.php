	...
	<BODY>
		...
		<div class="textTop">
			...
			<form name = "formm" method = "post" action = "./insertSQL.php">				
				<br> 학&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;년 :  <INPUT TYPE = "text" name = "grade" SIZE="60" placeholder="  0 (숫자만 입력해주세요.)">
				<br> 학&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;번 : <INPUT TYPE = "text" NAME = "studentid" SIZE="60" placeholder="  00000">
				...
				<br> 학&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;적 : <INPUT TYPE = "text" NAME = "studentrecord" SIZE="60" placeholder="  재학or휴학">
				<br> 전화번호 : <INPUT TYPE = "text" NAME = "phonenumber" SIZE="60" placeholder="  000-0000-0000">
			</form>  
			&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
