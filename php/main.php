      ...
      <div style="height: 108px; padding-bottom: 16px; flex-direction: column; justify-content: center; align-items: flex-start; gap: 4px; display: flex">
        ...
        <div style="align-self: stretch; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
          ...
          <div style="flex: 1 1 0; height: 40px; justify-content: flex-end; align-items: flex-start; gap: 8px; display: flex">
            ...
            <!--로그인 여기있어요!!!-->
            <!--로그인 여기있어요!!!-->
            <div onClick="javascript:move( './login.php' );" style="padding-left: 80vw; padding-right: 12px; padding-top: 10px; padding-bottom: 10px; border-radius: 6px; justify-content: center; align-items: center; gap: 8px; display: flex">
              ...
              <div style="color: #1D1D1D; font-size: 17px; font-family: NanumGothic; font-weight: 700; line-height: 25.50px; word-wrap: break-word", onClick="location.href='./login.php'">로그인</div>
            </div>
            <!--회원가입 여기있어요!!!-->
            <!--회원가입 여기있어요!!!-->
            <!--회원가입 여기있어요!!!-->
            <div onClick="javascript:move( './join.php' );" style="padding-left: 12px; padding-right: 12px; padding-top: 10px; padding-bottom: 10px; border-radius: 6px; justify-content: center; align-items: center; gap: 8px; display: flex">
              <div style="width: 20px; height: 20px; position: relative">
                <div style="width: 20px; height: 20px; left: 0px; top: 0px; position: absolute; opacity: 0.10"></div>
              ...
              <div style="color: #1D1D1D; font-size: 17px; font-family: NanumGothic; font-weight: 700; line-height: 25.50px; word-wrap: break-word", onClick="location.href='./signup.php'">회원가입</div>
            </div>
          </div>
        </div>
      </div>
