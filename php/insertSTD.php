  ...
  <div style="width: 100vw; height: 150vh; justify-content: center; align-items: flex-start; gap: 80px; display: inline-flex">
    ...
    <div style="align-self: stretch; padding-left: 16px; padding-right: 16px; border-radius: 12px; border: 2px #246BEB solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
      <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
        <div style="align-self: stretch; color: rgba(29, 29, 29, 0.50); font-size: 19px; font-family: NanumGothic; font-weight: 700; line-height: 28.50px; word-wrap: break-word"><input type="text" placeholder="학년" style="font-size: 19px; width: 355px; height:78px; border: 1px solid white; outline: none; background-color: transparent; value="";"></div>
      </div>
    </div>
    <div style="align-self: stretch; padding-left: 16px; padding-right: 16px; border-radius: 12px; border: 2px #246BEB solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
      <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
        <div style="align-self: stretch; color: rgba(29, 29, 29, 0.50); font-size: 19px; font-family: NanumGothic; font-weight: 700; line-height: 28.50px; word-wrap: break-word"><input type="text" placeholder="학번" style="font-size: 19px; width: 355px; height:78px; border: 1px solid white; outline: none; background-color: transparent; value="";"></div>
      </div>
    </div>
    <div style="align-self: stretch; padding-left: 16px; padding-right: 16px; border-radius: 12px; border: 2px #246BEB solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
      <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
        <div style="align-self: stretch; color: rgba(29, 29, 29, 0.50); font-size: 19px; font-family: NanumGothic; font-weight: 700; line-height: 28.50px; word-wrap: break-word"><input type="text" placeholder="이름" style="font-size: 19px; width: 355px; height:78px; border: 1px solid white; outline: none; background-color: transparent; value="";"></div>
      </div>
    </div>
    <div style="align-self: stretch;  padding-left: 16px; padding-right: 16px; border-radius: 12px; border: 2px #246BEB solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
      <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
        <div style="align-self: stretch; color: rgba(29, 29, 29, 0.50); font-size: 19px; font-family: NanumGothic; font-weight: 700; line-height: 28.50px; word-wrap: break-word"><input type="text" placeholder="생년월일" style="font-size: 19px; width: 355px; height:78px; border: 1px solid white; outline: none; background-color: transparent; value="";"></div>
      </div>
    </div>
    <div style="align-self: stretch;  padding-left: 16px; padding-right: 16px; border-radius: 12px; border: 2px #246BEB solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
      <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
        <div style="align-self: stretch; color: rgba(29, 29, 29, 0.50); font-size: 19px; font-family: NanumGothic; font-weight: 700; line-height: 28.50px; word-wrap: break-word"><input type="text" placeholder="성별" style="font-size: 19px; width: 355px; height:78px; border: 1px solid white; outline: none; background-color: transparent; value="";"></div>
      </div>
    </div>
    <div style="align-self: stretch; padding-left: 16px; padding-right: 16px; border-radius: 12px; border: 2px #246BEB solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
      <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
        <div style="align-self: stretch; color: rgba(29, 29, 29, 0.50); font-size: 19px; font-family: NanumGothic; font-weight: 700; line-height: 28.50px; word-wrap: break-word"><input type="text" placeholder="학적" style="font-size: 19px; width: 355px; height:78px; border: 1px solid white; outline: none; background-color: transparent; value="";"></div>
      </div>
    </div>
    <div style="align-self: stretch; padding-left: 16px; padding-right: 16px; border-radius: 12px; border: 2px #246BEB solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
      <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
        <div style="align-self: stretch; color: rgba(29, 29, 29, 0.50); font-size: 19px; font-family: NanumGothic; font-weight: 700; line-height: 28.50px; word-wrap: break-word"><input type="text" placeholder="전화번호" style="font-size: 19px; width: 355px; height:78px; border: 1px solid white; outline: none; background-color: transparent; value="";"></div>
      </div>
    </div>

    <div onClick="javascript:move( './insert.php' );" style="width: 130px; height: 35px; padding: 4px; background: #65A2FC; border-radius: 4px; justify-content: center; align-items: center; gap: 2px; display:flex; text-align:center; cursor:hand">
      <!--여기 추가하기버튼 있어요!!!!-->
      <!--여기 추가하기버튼 있어요!!!!-->
      <!--여기 추가하기버튼 있어요!!!!-->
      <!--여기 추가하기버튼 있어요!!!!-->
