...
<form name = "formm" method = "post">
        <div style="width: 685px; padding-left: 24px; padding-right: 24px;  background: white; border-radius: 12px; border: 2px #246BEB solid; justify-content: center; align-items: center; gap: 48px; display: inline-flex">
          ...
          <!--여기 검색 버튼있습니다!!!!!!-->
          <!--여기 검색 버튼있습니다!!!!!!-->
          <div onClick="document.formm.action='./searchPRF.php'; document.formm.submit();" style="width: 40px; height: 40px; position: relative; cursor:hand">
  ...
  <div style="text-align: center"><?php include("./selectPRFSQL.php"); ?></div>
  <!--여기까지 기능-->
