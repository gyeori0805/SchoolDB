  ...
  <div style="width: 100vw; height: 150vh; justify-content: center; align-items: flex-start; gap: 80px; display: inline-flex">
    ...
    <div style="align-self: stretch; padding-left: 16px; padding-right: 16px; border-radius: 12px; border: 2px #246BEB solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
      <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
        <div style="align-self: stretch; color: rgba(29, 29, 29, 0.50); font-size: 19px; font-family: NanumGothic; font-weight: 700; line-height: 28.50px; word-wrap: break-word"><input type="text" placeholder="교수번호" style="font-size: 19px; width: 355px; height:78px; border: 1px solid white; outline: none; background-color: transparent; value="";"></div>
      </div>
    </div>
    <div style="align-self: stretch; padding-left: 16px; padding-right: 16px; border-radius: 12px; border: 2px #246BEB solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
      <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
        <div style="align-self: stretch; color: rgba(29, 29, 29, 0.50); font-size: 19px; font-family: NanumGothic; font-weight: 700; line-height: 28.50px; word-wrap: break-word"><input type="text" placeholder="교수명" style="font-size: 19px; width: 355px; height:78px; border: 1px solid white; outline: none; background-color: transparent; value="";"></div>
      </div>
    </div>
    <div style="align-self: stretch; padding-left: 16px; padding-right: 16px; border-radius: 12px; border: 2px #246BEB solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
      <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
        <div style="align-self: stretch; color: rgba(29, 29, 29, 0.50); font-size: 19px; font-family: NanumGothic; font-weight: 700; line-height: 28.50px; word-wrap: break-word"><input type="text" placeholder="연구실" style="font-size: 19px; width: 355px; height:78px; border: 1px solid white; outline: none; background-color: transparent; value="";"></div>
      </div>
    </div>
    <div style="align-self: stretch;  padding-left: 16px; padding-right: 16px; border-radius: 12px; border: 2px #246BEB solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
      <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
    ...
    <div style="align-self: stretch;  padding-left: 16px; padding-right: 16px; border-radius: 12px; border: 2px #246BEB solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
      <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
        <div style="align-self: stretch; color: rgba(29, 29, 29, 0.50); font-size: 19px; font-family: NanumGothic; font-weight: 700; line-height: 28.50px; word-wrap: break-word"><input type="text" placeholder="학과" style="font-size: 19px; width: 355px; height:78px; border: 1px solid white; outline: none; background-color: transparent; value="";"></div>
      </div>
    </div>
