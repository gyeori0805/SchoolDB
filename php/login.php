...
<div style="width: 100vw; height: 1405px; position: relative; background: white">
  ...
  <!--로그인-->
  <div style="padding-bottom: 80px; left: 430px; top: 292px; position: absolute; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 80px; display: inline-flex">
    <div style="flex-direction: column; justify-content: center; align-items: flex-start; gap: 24px; display: flex">
      <div style="color: #1D1D1D; font-size: 19px; font-family: NanumGothic; font-weight: 700; line-height: 28.50px; word-wrap: break-word">SEM 사용자 로그인</div>
    ...
    <div style="flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 40px; display: flex">
      <div style="width: 1060px; padding: 40px; border-top: 1px #D8D8D8 solid; border-bottom: 1px #D8D8D8 solid; justify-content: center; align-items: flex-start; gap: 40px; display: inline-flex">
        <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
          <div style="align-self: stretch; height: 79px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 12px; display: flex">
            ...
            <div style="align-self: stretch; height: 56px; padding-left: 16px; padding-right: 16px; background: white; border-radius: 8px; border: 1px #717171 solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
              <div style="flex: 1 1 0; color: #8E8E8E; font-size: 19px; font-family: NanumGothic; font-weight: 400; line-height: 28.50px; word-wrap: break-word"><input type="text" placeholder="영문 소문자" style="font-size: 19px; width: 455.5px; height:42.5px; border: 1px solid white; background-color: transparent; value="";"></div>
            </div>
          </div>
          <div style="align-self: stretch; height: 79px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 12px; display: flex">
            ...
            <div style="align-self: stretch; height: 56px; padding-left: 16px; padding-right: 16px; background: white; border-radius: 8px; border: 1px #717171 solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
              <div style="flex: 1 1 0; color: #8E8E8E; font-size: 19px; font-family: NanumGothic; font-weight: 400; line-height: 28.50px; word-wrap: break-word"><input type="text" placeholder="8-12자의 영문자, 숫자, 특수문자 조합" style="font-size: 19px; width: 455.5px; height:42.5px; border: 1px solid white; background-color: transparent; value="";"></div>
            </div>
          </div>
          <div onClick="javascript:move( './!!!!!!로그인 판단해주세요!!.php');" style="align-self: stretch; height: 56px; padding-left: 20px; padding-right: 20px; background: #246BEB; border-radius: 8px; justify-content: center; align-items: center; gap: 4px; display: inline-flex">
            ...
            <!--여기 로그인 버튼 있어요!!!!!!!!!!-->
            <!--여기 로그인 버튼 있어요!!!!!!!!!!-->
            <div onClick="javascript:move( './!!!!!!!!로그인 판단해주세요!!.php');" class='pointer'; style="color: white; font-size: 19px; font-family: NanumGothic; font-weight: 400; line-height: 28.50px; word-wrap: break-word">로그인</div>
          </div>
          <div style="align-self: stretch; justify-content: center; align-items: center; gap: 8px; display: inline-flex">
            <div style="width: 68px; padding: 2px; border-radius: 6px; justify-content: center; align-items: center; gap: 4px; display: flex">
              <div onClick="location.href='./signup.php'"; class='pointer'; style="color: #1D1D1D; font-size: 17px; font-family: NanumGothic; font-weight: 400; line-height: 25.50px; word-wrap: break-word">회원가입</div>
            </div>
          </div>
        </div>
        <div style="width: 1px; align-self: stretch; justify-content: center; align-items: flex-start; gap: 10px; display: flex">
          <div style="width: 1px; align-self: stretch; background: #D8D8D8"></div>
        </div>
        <div style="flex: 1 1 0; align-self: stretch; padding-top: 24px; padding-bottom: 24px; flex-direction: column; justify-content: center; align-items: center; gap: 24px; display: inline-flex">
          <img style="width: 305px; height: 299px" src="https://via.placeholder.com/305x299" />
        </div>
      </div>
      <div style="align-self: stretch; height: 97px; padding: 24px; background: #EDF1F5; border-radius: 12px; border: 1px #E4E4E4 solid; flex-direction: column; justify-content: center; align-items: flex-start; gap: 16px; display: flex">
        <div style="align-self: stretch; justify-content: flex-start; align-items: center; gap: 4px; display: inline-flex">
          <div style="width: 20px; height: 20px; position: relative">
            <div style="width: 20px; height: 20px; left: 0px; top: 0px; position: absolute; opacity: 0.10"></div>
            <div style="width: 16px; height: 16px; left: 2px; top: 2px; position: absolute"></div>
            <div style="width: 16px; height: 16px; left: 2px; top: 18px; position: absolute; background: #003675; border-radius: 70px"></div>
            <div style="width: 1.67px; height: 5px; left: 9.17px; top: 9.17px; position: absolute; background: white"></div>
            <div style="width: 1.67px; height: 0.83px; left: 8.33px; top: 9.17px; position: absolute; background: white"></div>
            <div style="width: 3.33px; height: 0.83px; left: 8.33px; top: 13.33px; position: absolute; background: white"></div>
            <div style="width: 2.08px; height: 2.08px; left: 8.75px; top: 5.83px; position: absolute; background: white; border-radius: 9999px"></div>
          </div>
          <div style="flex: 1 1 0; color: #003675; font-size: 17px; font-family: NanumGothic; font-weight: 700; line-height: 25.50px; word-wrap: break-word">로그인에 어려움이 있으신가요?</div>
        </div>
        <div style="align-self: stretch; height: 13px; padding-left: 24px; flex-direction: column; justify-content: center; align-items: flex-start; gap: 16px; display: flex">
          <div style="align-self: stretch; height: 13px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 16px; display: flex">
            <div style="align-self: stretch; justify-content: flex-start; align-items: flex-start; display: inline-flex">
              <div style="width: 12px; padding-right: 8px; justify-content: flex-start; align-items: center; gap: 10px; display: flex">
                <div style="width: 4px; height: 4px; background: #555555; border-radius: 4px"></div>
              </div>
              <div style="flex: 1 1 0"><span style="color: #555555; font-size: 17px; font-family: NanumGothic; font-weight: 400; line-height: 25.50px; word-wrap: break-word">로그인 </span><span style="color: #555555; font-size: 17px; font-family: NanumGothic; font-weight: 400; text-decoration: underline; line-height: 25.50px; word-wrap: break-word">관련 도움말</span><span style="color: #555555; font-size: 17px; font-family: NanumGothic; font-weight: 400; line-height: 25.50px; word-wrap: break-word">이나 다른 사용자가 </span><span style="color: #555555; font-size: 17px; font-family: NanumGothic; font-weight: 400; text-decoration: underline; line-height: 25.50px; word-wrap: break-word">자주 찾는 질문</span><span style="color: #555555; font-size: 17px; font-family: NanumGothic; font-weight: 400; line-height: 25.50px; word-wrap: break-word">을 확인해보세요.</span></div>
            </div>
          </div>
        </div>
      </div>
