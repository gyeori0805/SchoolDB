...
<?php 
	...
	while( $result = mysqli_fetch_array( $resultSet ) )
	{
		<table border="1" bordercolor="skyblue" align = "center" >
			<tr align = "center">
				<td style="font-size:25"><?php echo .$result['grade']; ?></td>
				<td style="font-size:25"><?php echo .$result['studentid']; ?></td>
				<td style="font-size:25"><?php echo .$result['name']; ?></td>
				<td style="font-size:25"><?php echo .$result['birth']; ?></td>
				<td style="font-size:25"><?php echo .$result['gender']; ?></td>
				<td style="font-size:25"><?php echo .$result['studentrecord']; ?></td>
				<td style="font-size:25"><?php echo .$result['phonenumber']; ?></td>
			</tr>
		</table>
	}
