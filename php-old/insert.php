  ...
  <div style="align-self: stretch; height: 360px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: flex">
    <div style="align-self: stretch; padding-left: 16px; padding-right: 16px; border-radius: 12px; border: 1px #C6C6C6 solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
      <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
        <div style="align-self: stretch; color: rgba(29, 29, 29, 0.50); font-size: 19px; font-family: NanumGothic; font-weight: 700; line-height: 28.50px; word-wrap: break-word"><input type="text" NAME = "grade" SIZE="60" placeholder="학년" style="font-size: 19px; width: 355px; height:78px; border: 1px solid white; background-color: transparent; value="";"></div>
      </div>
    </div>
    <div style="align-self: stretch; padding-left: 16px; padding-right: 16px; border-radius: 12px; border: 1px #C6C6C6 solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
      <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
        <div style="align-self: stretch; color: rgba(29, 29, 29, 0.50); font-size: 19px; font-family: NanumGothic; font-weight: 700; line-height: 28.50px; word-wrap: break-word"><input type="text" NAME = "studentid" SIZE="60" placeholder="학번" style="font-size: 19px; width: 355px; height:78px; border: 1px solid white; background-color: transparent; value="";"></div>
      </div>
    ...
    <div style="align-self: stretch; height: 72px; padding-left: 16px; padding-right: 16px; border-radius: 12px; border: 1px #C6C6C6 solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
      <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
        <div style="align-self: stretch; color: rgba(29, 29, 29, 0.50); font-size: 19px; font-family: NanumGothic; font-weight: 700; line-height: 28.50px; word-wrap: break-word"><input type="text" NAME = "name" SIZE="60" placeholder="이름" style="font-size: 19px; width: 355px; height:78px; border: 1px solid white; background-color: transparent; value="";"></div>
      </div>
      
    </div>
    <div style="align-self: stretch; height: 72px; padding-left: 16px; padding-right: 16px; border-radius: 12px; border: 1px #C6C6C6 solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
      <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
        <div style="align-self: stretch; color: rgba(29, 29, 29, 0.50); font-size: 19px; font-family: NanumGothic; font-weight: 700; line-height: 28.50px; word-wrap: break-word"><input type="text" NAME = "birth" SIZE="60" placeholder="생년월일" style="font-size: 19px; width: 355px; height:78px; border: 1px solid white; background-color: transparent; value="";"></div>
      </div>
      
    </div>
    <div style="align-self: stretch; height: 72px; padding-left: 16px; padding-right: 16px; border-radius: 12px; border: 1px #C6C6C6 solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
      <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
        <div style="align-self: stretch; color: rgba(29, 29, 29, 0.50); font-size: 19px; font-family: NanumGothic; font-weight: 700; line-height: 28.50px; word-wrap: break-word"><input type="text" NAME = "gender" SIZE="60" placeholder="성별" style="font-size: 19px; width: 355px; height:78px; border: 1px solid white; background-color: transparent; value="";"></div>
      </div>
      
    </div>
    <div style="align-self: stretch; height: 72px; padding-left: 16px; padding-right: 16px; border-radius: 12px; border: 1px #C6C6C6 solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
      <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
        <div style="align-self: stretch; color: rgba(29, 29, 29, 0.50); font-size: 19px; font-family: NanumGothic; font-weight: 700; line-height: 28.50px; word-wrap: break-word"><input type="text" NAME = "studentrecord" SIZE="60" placeholder="학적" style="font-size: 19px; width: 355px; height:78px; border: 1px solid white; background-color: transparent; value="";"></div>
      </div>
      
    </div>
    <div style="align-self: stretch; height: 72px; padding-left: 16px; padding-right: 16px; border-radius: 12px; border: 1px #C6C6C6 solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
      <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
        <div style="align-self: stretch; color: rgba(29, 29, 29, 0.50); font-size: 19px; font-family: NanumGothic; font-weight: 700; line-height: 28.50px; word-wrap: break-word"><input type="text" NAME = "phonenumber" SIZE="60" placeholder="전화번호" style="font-size: 19px; width: 355px; height:78px; border: 1px solid white; background-color: transparent; value="";"></div>
      </div>
    </div>
</form>
    <div onClick="javascript:document.formm.submit();" style="width: 130px; height: 30px; padding: 2px; background: #65A2FC; border-radius: 4px; justify-content: center; align-items: center; gap: 2px; display: inline-flex; text-align:center; cursor:hand">
      <!--여기 추가하기버튼 있어요!!!!-->
      <!--여기 추가하기버튼 있어요!!!!-->
      <!--여기 추가하기버튼 있어요!!!!-->
      <!--여기 추가하기버튼 있어요!!!!-->
      <div style="text-align: center; color: white; font-size: 15px; font-family: NanumGothic; font-weight: 700; line-height: 22.50px; word-wrap: break-word">추가하기</div>
    </div>
  </div>
</div>
